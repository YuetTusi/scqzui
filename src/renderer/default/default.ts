...
import androidSetModal from '@/model/default/android-set-modal';
import paperworkModal from '@/model/default/paperwork-modal';
import quickLogTable from '@/model/default/quick-log-table';
import helpModal from '@/model/default/help-modal';
import fetchStateModal from '@/model/default/fetch-state-modal';
import imeiModal from '@/model/default/imei-modal';
import cleanViolationModal from '@/model/default/clean-violation-modal';
import normalInputModal from '@/model/default/normal-input-modal';
import wifiBoxModal from '@/model/default/wifi-box-modal';
import 'jquery';
...
app.model(apkModal);
app.model(login);
app.model(androidSetModal);
app.model(quickLogTable);
app.model(helpModal);
app.model(fetchStateModal);
app.model(imeiModal);
app.model(cleanViolationModal);
app.model(normalInputModal);
app.model(paperworkModal);
app.model(wifiBoxModal);
